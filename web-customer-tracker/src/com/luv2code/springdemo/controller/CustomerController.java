...
public class CustomerController {
	...
	public String listCustomers(Model theModel) {
		...
		theModel.addAttribute("customers", listCustomers); // model.addAttribute takes key and the value. key is used in the JSP file.
	...
	public String showFormForUpdate(@RequestParam("customerId") int theId, Model theModel) {
		...
		// get the data for the given customer id
		Customer theCustomer = customerService.getCustomer(theId);
		
		// set customer as a model attribut to pre-populate the customer form
		theModel.addAttribute("customer", theCustomer);
